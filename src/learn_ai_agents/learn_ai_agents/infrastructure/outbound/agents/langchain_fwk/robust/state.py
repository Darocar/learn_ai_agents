"""State definition for the robust agent.

This module defines the graph state used by the LangGraph-based robust agent.
"""
...
class State(TypedDict):
    """Graph state definition for the robust agent.
